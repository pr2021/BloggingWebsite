...
from Post.core.views import core
from Post.users.views import users
from Post.blog_posts.views import blog_posts
from Post.error_pages.handlers import error_pages
